...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        categories = Category.objects.all()         # получаем все категории из модели Category
        products = []
        ...
        Product.objects.bulk_create(products)           # bulk_create принимает список объектов и эти объекты через один запрос помещает в БД
